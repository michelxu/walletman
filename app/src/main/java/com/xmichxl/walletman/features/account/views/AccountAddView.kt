package com.xmichxl.walletman.features.account.views
...
import com.xmichxl.walletman.core.components.ButtonAtBottom
import com.xmichxl.walletman.core.components.ColorPickerDropdown
import com.xmichxl.walletman.core.components.DropdownTextField
import com.xmichxl.walletman.core.components.MainIconButton
import com.xmichxl.walletman.core.components.MainTextField
import com.xmichxl.walletman.core.components.MainTitle
import com.xmichxl.walletman.core.components.NumericTextField
import com.xmichxl.walletman.core.components.WarningFormText
import com.xmichxl.walletman.features.account.data.Account
import com.xmichxl.walletman.core.utils.AccountType
import com.xmichxl.walletman.core.utils.AppConstants
import com.xmichxl.walletman.core.utils.FORM_ERROR_ACCOUNT
import com.xmichxl.walletman.core.utils.FORM_ERROR_BALANCE
import com.xmichxl.walletman.core.utils.FORM_ERROR_CREDIT_LIMIT
import com.xmichxl.walletman.core.utils.FORM_ERROR_NAME
import com.xmichxl.walletman.core.utils.validateForm
import com.xmichxl.walletman.core.utils.validateInput
import com.xmichxl.walletman.features.account.viewmodels.AccountViewModel

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun AccountAddView(navController: NavController, modifier: Modifier, accountViewModel: AccountViewModel) {
    Scaffold(topBar = {
